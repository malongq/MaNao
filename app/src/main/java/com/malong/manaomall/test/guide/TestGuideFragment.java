 ...
 * 引导页fragment
 */
public class TestGuideFragment extends Fragment {
    ...
    public static TestGuideFragment newInstance(int imgResId, int bgColorId, int textResId) {

        TestGuideFragment guideFragment = new TestGuideFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mView = inflater.inflate(R.layout.test_fragment_guide, container, false);
